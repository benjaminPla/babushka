...
impl Enrollment {
    ...
    pub fn reconstitute(
        ...
        Self { id, student_id, student_name, course_period_id, period_label, period_end_date, course_name, agreed_price_cents, dropped_at, latest_payment, enrolled_at, updated_at }
    }
