...
pub struct Course {
    ...
    class_price_cash_cents:     Cents,
    class_price_transfer_cents: Cents,
    created_at:                 DateTime<Utc>,
    id:                         Uuid,
    month_price_cash_cents:     Cents,
    month_price_transfer_cents: Cents,
    name:                       CourseName,
    notes:                      Option<Notes>,
    teacher_id:                 Uuid,
...
impl Course {
    ...
    pub fn class_price_cash_cents(&self)     -> Cents { self.class_price_cash_cents }
    pub fn class_price_transfer_cents(&self) -> Cents { self.class_price_transfer_cents }
    pub fn created_at(&self)                -> DateTime<Utc> { self.created_at }
    pub fn id(&self)                        -> Uuid   { self.id }
    pub fn month_price_cash_cents(&self)     -> Cents { self.month_price_cash_cents }
    pub fn month_price_transfer_cents(&self) -> Cents { self.month_price_transfer_cents }
